...
module ui {
    export class alertUI extends Dialog {
        ...
        public static  uiView:any ={"type":"Dialog","props":{"width":720,"height":1280},"child":[{"type":"Button","props":{"y":1020,"x":152,"var":"reset","stateNum":1,"skin":"index/btn_play_againx.png","name":"reset"}}]};
        constructor(){ super()}
        createChildren():void {
